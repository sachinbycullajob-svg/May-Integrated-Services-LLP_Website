  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in">
      <div className={`w-full max-w-3xl max-h-[85vh] overflow-y-auto p-6 sm:p-8 rounded-3xl border shadow-2xl relative ${
        themeMode === 'dark' ? 'bg-slate-900 border-slate-800 text-slate-300' : 'bg-beige-50 border-slate-200 text-slate-800'
      }`}>
        ...
        <div className="text-center mb-8 pr-8">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-maroon-500/10 border border-maroon-500/30 text-maroon-400 text-xs font-semibold mb-3">
          ...
          {isPrivacy ? (
            <>
              <section className="space-y-2">
                <h3 className="text-sm font-bold text-maroon-400">1. Data Controller Identity</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-bold text-maroon-400">2. Information Collection</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-bold text-maroon-400">3. Purpose of Processing</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-bold text-maroon-400">4. Data Security & Storage</h3>
                <p>
            ...
            <>
              <section className="space-y-2">
                <h3 className="text-sm font-bold text-maroon-400">1. Agreement to Terms</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-bold text-maroon-400">2. Intellectual Property Rights</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-bold text-maroon-400">3. Limitation of Liability</h3>
                <p>
