  ...
  return (
    <div className="py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-xs sm:text-sm leading-relaxed">
      ...
      <div className={`p-8 sm:p-10 rounded-3xl border space-y-6 ${
        themeMode === 'dark' ? 'bg-slate-900/90 border-slate-800 text-slate-300' : 'bg-beige-50 border-slate-200 text-slate-800 shadow-xl'
      }`}>
        
        {isPrivacy ? (
          <>
            <section className="space-y-2">
              <h3 className="text-base font-bold text-maroon-400">1. Data Controller Identity</h3>
              <p>
            ...
            <section className="space-y-2">
              <h3 className="text-base font-bold text-maroon-400">2. Information Collection</h3>
              <p>
            ...
            <section className="space-y-2">
              <h3 className="text-base font-bold text-maroon-400">3. Purpose of Processing</h3>
              <p>
            ...
            <section className="space-y-2">
              <h3 className="text-base font-bold text-maroon-400">4. Data Security & Storage</h3>
              <p>
          ...
          <>
            <section className="space-y-2">
              <h3 className="text-base font-bold text-maroon-400">1. Agreement to Terms</h3>
              <p>
            ...
            <section className="space-y-2">
              <h3 className="text-base font-bold text-maroon-400">2. Intellectual Property Rights</h3>
              <p>
            ...
            <section className="space-y-2">
              <h3 className="text-base font-bold text-maroon-400">3. Limitation of Liability</h3>
              <p>
