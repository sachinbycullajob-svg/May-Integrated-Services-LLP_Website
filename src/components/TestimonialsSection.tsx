      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className={`text-3xl sm:text-4xl font-extrabold tracking-tight ${
            ...
            Trusted By <span className="text-sky-400">Marketplace Collaborators</span>
          </h2>
              ...
              <div className={`h-full p-7 rounded-3xl border flex flex-col justify-between transition-all duration-300 ${
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[10px] font-mono font-bold bg-sky-500/15 text-sky-400 px-2 py-0.5 rounded border border-sky-500/20">
                      {t.marketplace}
                    </span>
                  </div>
